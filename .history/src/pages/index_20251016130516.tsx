  ...
  const compareExcelFiles = async () => {
    ...
    try {
      ...
      oldData.forEach(oldRow => {
        ...
        if (seq == null || description == null) return;
      ...
      <div className="dashboard-content">
        ...
        {comparisonResult && (
          <div className="summary-card">
            ...
            <p>Files compared based on <strong>Description</strong> column. Click on the buttons below to view details.</p>
              ...
              <div className="results-section">
                <div className="results-header">
                  ...
                  <p className="results-description">
                    {activeView === 'canceled' && 
                      'These items were present in the old file but are missing in the new file (deleted items based on Description).'}
                    {activeView === 'edited' && 
                      'These items have changes in Seq., Quantity, Unit Price, or Amount. Changed values are highlighted in red with a pencil icon (✎).'}
                    {activeView === 'noChange' && 
                      'These items remain exactly the same in both files - no changes detected in any compared fields.'}
                  </p>
                </div>
