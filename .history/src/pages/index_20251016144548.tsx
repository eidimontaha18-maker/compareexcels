    ...
    <div className="dashboard">
      ...
      <div className="dashboard-content">
        <header className="page-header">
          ...
          <p>Matches items by <strong>Seq. + Description + Code</strong>, then detects changes in <strong>Quantity (Qty), Unit Price, and Amount</strong></p>
        </header>
        ...
        {comparisonResult && (
          <div className="summary-card">
            ...
            <p>Files compared using <strong>Seq. + Description + Code</strong> as matching keys. Changes detected in <strong>Quantity (Qty/PCS), Unit Price, and Amount</strong>.</p>
