        ...
        try {
          ...
          if (headerRowIndex === -1) {
            ...
            const columnNames = headerRow.map((header, index) => {
              ...
              if (headerStr === '') {
                // Empty header - need to determine what this column is
                // Check previous column to identify position
                const prevHeader = index > 0 ? String(headerRow[index - 1] || '').toLowerCase() : '';
                
                // If previous column is Description, this is the Code column (part numbers)
                if (prevHeader.includes('desc') || prevHeader.includes('description')) {
                  return 'Code';
                }
                // Otherwise, assign generic name
          ...
          <>
            <div className="filter-section">
              ...
              >
                ...
                <span className="filter-label">Deleted</span>
              ...
              >
                ...
                <span className="filter-label">Modified</span>
              ...
              >
                ...
                <span className="filter-label">Unchanged</span>
              ...
              <div className="results-section">
                <div className="results-header">
                  ...
                  <p className="results-description">
                    ...
                    {activeView === 'edited' && 
                      'Items with the SAME Seq. and Description, but with changes in Quantity, Unit Price, or Amount. Changed values are highlighted.'}
                    {activeView === 'noChange' && 
